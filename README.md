...
Windows currently gets the best trick: ZXJetMen can use visible desktop window edges as platforms.

macOS support is intentionally simpler for now. The overlay is click-through, but the platforms are generated by the app rather than discovered from real system windows.
